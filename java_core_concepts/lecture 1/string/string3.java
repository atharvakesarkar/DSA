...
class string3 {
    ...
    // System.out.println(name1 + " "+ name2); //concatenate using add opertor




    // Use of charAT for getting the char on define value

    // String firstname = "Atharva";
    // System.out.println(firstname.charAt(1)); 

    // NOTE - in java you cannot give negative indexing...




    // LENGTH - it use for getting length of string
